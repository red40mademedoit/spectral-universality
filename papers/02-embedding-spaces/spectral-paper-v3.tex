...
is consistent with tokenization: Qwen produces 82.8\%
single-character tokens for polytonic Greek vs.\ 12.8\% for English
(Section~\ref{sec:trajectories}).  A definitive control would
require comparing a Greek-specific tokenizer (e.g., GreekBERT)
against Qwen on the same texts; this is not possible without
swapping models entirely.
